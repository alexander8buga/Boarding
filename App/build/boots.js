...
.valid-tooltip {
  ...
  line-height: 1;
  color: #fff;
  background-color: rgba(115, 168, 57, 0.8);
  border-radius: .2rem;
}
...
.was-validated .custom-control-input:valid ~ .custom-control-indicator, .custom-control-input.is-valid ~ .custom-control-indicator {
  background-color: rgba(115, 168, 57, 0.25);
}
...
.invalid-tooltip {
  ...
  line-height: 1;
  color: #fff;
  background-color: rgba(199, 28, 34, 0.8);
  border-radius: .2rem;
}
...
.was-validated .custom-control-input:invalid ~ .custom-control-indicator, .custom-control-input.is-invalid ~ .custom-control-indicator {
  background-color: rgba(199, 28, 34, 0.25);
}
...
.custom-file-input:focus ~ .custom-file-control {
  -webkit-box-shadow: 0 0 0 0.075rem #fff, 0 0 0 0.2rem #2FA4E7;
          box-shadow: 0 0 0 0.075rem #fff, 0 0 0 0.2rem #2FA4E7;
}
...
.bg-primary {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#54b4eb), color-stop(60%, #2FA4E7), color-stop(60%, #1d9ce5));
...
.bg-dark {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#04519b), color-stop(60%, #033C73), color-stop(60%, #02325f));
...
.bg-light {
  background-image: -webkit-gradient(linear, left top, left bottom, from(white), color-stop(60%, #e9ecef), color-stop(60%, #e3e7eb));
...
.btn-secondary {
  background-image: -webkit-gradient(linear, left top, left bottom, from(white), color-stop(60%, #e9ecef), color-stop(60%, #dde2e6));
  background-image: -webkit-linear-gradient(white, #e9ecef 60%, #dde2e6);
  background-image: -o-linear-gradient(white, #e9ecef 60%, #dde2e6);
...
.btn-success {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#88c149), color-stop(60%, #73A839), color-stop(60%, #699934));
...
.btn-warning {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#ff6707), color-stop(60%, #DD5600), color-stop(60%, #c94e00));
...
.btn-danger {
  background-image: -webkit-gradient(linear, left top, left bottom, from(#e12b31), color-stop(60%, #C71C22), color-stop(60%, #b5191f));
